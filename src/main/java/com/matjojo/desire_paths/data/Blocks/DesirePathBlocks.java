...
public class DesirePathBlocks {
    ...
    public static final Block GRASS_DIRT_INTER = new Trampleable(FabricBlockSettings.copy(Blocks.GRASS_BLOCK).ticksRandomly().dropsLike(Blocks.GRASS_BLOCK).build());
    public static final Block PODZOL_DIRT_INTER = new Trampleable(FabricBlockSettings.copy(Blocks.PODZOL).ticksRandomly().dropsLike(Blocks.PODZOL).build());
    public static final Block MYCELIUM_DIRT_INTER = new Trampleable(FabricBlockSettings.copy(Blocks.MYCELIUM).ticksRandomly().dropsLike(Blocks.MYCELIUM).build());
